/*!
 * @license
 * TradingView Lightweight Charts v3.6.0-dev+202108201622
...
(function () {
    ...
    ***************************************************************************** */
    ...
    function drawLine(ctx, centerX, color) {
        ctx.beginPath();
        ctx.setLineDash([5, 5]);
    ...
    function hitTestLine(centerX, centerY, size, x, y) {
        var circleSize = shapeSize('circle', size);
        var tolerance = 2 + circleSize / 2;
        var xOffset = centerX - x;
        var yOffset = centerY - y;
    ...
    function drawShape(item, ctx) {
        ...
        switch (item._internal_shape) {
            ...
            case 'square':
                ...
                return;
            case 'line':
                drawLine(ctx, item._internal_x, item._internal_color);
                return;
        }
    ...
    function hitTestShape(item, x, y) {
        ...
        switch (item._internal_shape) {
            ...
            case 'line':
                return hitTestLine(item._internal_x, item._internal_y, item._internal_size, x, y);
        }
        ensureNever(item._internal_shape);
    }
